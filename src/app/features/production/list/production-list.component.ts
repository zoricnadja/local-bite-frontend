                ...
                <tr class="clickable-surface" [routerLink]="b.id" #detailLink tabindex="0"
                  ...
                  <td>
                    <div class="actions" (click)="$event.stopPropagation()">
                      ...
                      <button *appCan="'deleteBusinessData'" class="icon-action" (click)="confirmDelete(b)" title="Delete" aria-label="Delete"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 6h18M9 6V3h6v3M5 6l1 15h12l1-15M10 10v7M14 10v7"/></svg></button>
                    </div>
                  </td>
                </tr>
              }
